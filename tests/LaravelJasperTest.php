...
namespace Drsoft\LaravelJasper\Test;

use PHPUnit\Framework\TestCase;
use Drsoft\LaravelJasper\LaravelJasper;
 ...
 */
final class LaravelJasperTest extends TestCase
{
    private $instance;

    public function setUp(): void
    {
        $this->instance = new LaravelJasper();
    }

    /** @test */
    public function constructor()
    {
        $this->assertInstanceOf(LaravelJasper::class, new LaravelJasper());
    }
